...
if __name__ == "__main__":
    ...
    #固定比例
    #output_dir = os.path.join(output_dir, 'multivariate_datasets_' + 'flexible' + '_shot')#
    ...
    for dataset_name in multivariate_datasets:
        ...
        # Read data
        X, y, train_idx, test_idx = read_multivariate_dataset(multivariate_dir, dataset_name, args.shot)
